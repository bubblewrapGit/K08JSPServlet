...
<body>
	...
	<!-- 
	이클립스에서는 우리가 직겁 작성한 파일을 실행하는 것이 아니고
	metadata폴더 하위에 프로젝트와 동일한 환경을 만들어서 복사본 파일이 실행된다.
	...
	<%!
	/*
		선언부에서는 내장객체를 바로 사용하는 건 불가능 하다.
		내장 객체는 _jspService()메서드내에서 생성된 지역변수 임으로
		더 넓은 지역인 선언부에서 사용하려면 매개변수로 전달받아야 한다.
	*/
	public String useImplicitObject(){
		/*
		 방법1 : getServletContext() 메서드를 통해 선언부에서 
		 	application 내장객체를 얻어올수 있다.
		*/
